...
- contract.ts: export type Challenge =; export type UserPoints =; export type ChallengeProgress =; export type getChallengeByIdFn = (id: string) => Promise<Challenge | null>; export type listChallengesFn = (filters?:; export type getUserPointsFn = (userId: string) => Promise<UserPoints | null>; export type recordChallengeCompletionFn = (userId: string, challengeId: string, pointsEarned: number) => Promise<void>; export type calculatePointsFn = (challengeId: string) => number
